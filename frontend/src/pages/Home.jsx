...
import test1 from '../assets/homePic.png'
        ...
        <>
         <section className='home'>
                <div className='left'>
                    ...
                    At TasteBuds, we believe everyone has a recipe worth sharing. Our platform lets you easily create and share your own recipes, as well as explore a growing collection of mouthwatering dishes submitted by other food enthusiasts. We're here to help you cook, discover, and connect.   
                    </h5>
                ...
                <div className='right'>
                    <img className ='picture' src = {test1}/>
                </div>
            </section>
            <div className = 'bg'>
